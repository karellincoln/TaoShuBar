...
public class LoginRegisterFragment extends Fragment {
    ...
    public EditText registerAccount,registerPassword;
   ...
   public Button confirmRegisterButton;
    ...
    public EditText getRegisterAccount() {
        return registerAccount;
    }

    public EditText getRegisterPassword() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View containField = inflater.inflate(R.layout.fragment_login_register, container, false);
        registerAccount=(EditText)containField.findViewById(R.id.register_account_input);
        registerPassword = (EditText)containField.findViewById(R.id.register_password_input);
        confirmRegisterButton=(Button)containField.findViewById(R.id.confirm_register);
